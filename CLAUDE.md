...
| **B** (Implementation) | `/<PK>:dev-feature WX-XXX` | Execute all tasks under an epic |
| **B** (Single issue) | `/<PK>:dev-task WX-XXX` | Execute a single task with TDD |
